...
\includegraphics[width=0.235\textwidth]{driver_shots/source_phone.jpg}\hfill
...
location source and the upcoming stop sequence listed; (c) an active
trip publishing \textsc{live}: next stop (11 of 17) with its ETA,
current speed, GPS accuracy, seconds since the last update, and the
\emph{End trip} control; (d) the stop-by-stop progress view with
done/next/upcoming states, stop names rendered in both scripts.}
\label{fig:driver}
\end{figure}
