...
{\Large \textbf{UniBus Live: A Real-Time Bilingual University Bus\\[0.15cm]
Tracking System with Resilient Dual-Source\\[0.15cm]
GPS Acquisition}}\\[1.2cm]
...
\begin{tabular}{ll}
\textbf{Md.\ Shishir Hossain} & ID: 1005 \\
\textbf{Md.\ Sajib Hasan}     & ID: 1008 \\
\textbf{Md.\ Showkat Hossen}  & ID: 1009 \\
\end{tabular}\\[0.2cm]
...
ID: 1005, Batch: 12th & \\[1.4cm]
\rule{5.5cm}{0.4pt} & \\
\textbf{Md.\ Sajib Hasan} & \\
ID: 1008, Batch: 12th & \\[1.4cm]
\rule{5.5cm}{0.4pt} & \\
...
This is to certify that the thesis titled \emph{``UniBus Live: A Real-Time
Bilingual University Bus Tracking System with Resilient Dual-Source GPS
Acquisition''}, submitted by Md.\ Shishir Hossain (ID: 1005), Md.\ Sajib
Hasan (ID: 1008), and Md.\ Showkat Hossen (ID: 1009) of the 12th batch,
Department of Computer Science and Engineering, NPI University of
Bangladesh, has been carried out under my supervision. It is hereby
approved as a partial fulfillment of the requirements for the degree of
Bachelor of Science in Computer Science and Engineering.

The work embodied in this thesis is, to the best of my knowledge, original
