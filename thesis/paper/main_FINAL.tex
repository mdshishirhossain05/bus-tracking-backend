...
\end{tikzpicture}}%
\caption{UniBus Live system architecture. The fixed GPS tracker is the
primary position source and operates with no driver involvement; the
driver's smartphone serves only as an automatic fallback. All backend
components run on a single low-cost cloud server.}
