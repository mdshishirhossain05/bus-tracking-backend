...
\draw[barr] ($(trac.east)+(0,-3.6mm)$) -- ($(app.west)+(0,-3.6mm)$)
  node[lab, midway, anchor=north, yshift=-0.3mm] {REST poll\\(backup)};
\draw[arr, rounded corners=1.5pt] ($(app.south)+(-16mm,0)$) -- ++(0,-1.9mm) -| (pg.north);
\draw[arr] (app.south -| rd) -- (rd.north);
\coordinate (pX) at ($(pass.north)+(0,0)$);
...
\draw[barr] (aX |- bzone.south) -- (aX)
  node[lab, midway, anchor=west, xshift=0.8mm] {REST API\\management};
% legend
\node[anchor=north, font=\tiny] at ($(czone.south)+(0,-1.8mm)$)
  {\tikz{\draw[arr] (0,0) -- (4.5mm,0);}\, real-time location data\qquad
   \tikz{\draw[barr] (0,0) -- (4.5mm,0);}\, request / response (REST)};
\end{tikzpicture}}%
